...
const nextConfig = {
  experimental: {
    ...
    // Keep next-auth / stripe as Node require – avoids webpack inlining process.env at build time
    serverComponentsExternalPackages: ['next-auth', 'otplib', 'qrcode', 'stripe'],
  },
  images: {
