/**
 * Admin valós idejű anomália: nagy CSV-export, tömeges árváltoztatás, tömeges törlés.
 * Küszöbök env-ből felülírhatók; a belépést / műveletet nem blokkolják.
 */
...
export function buildAdminAnomalyHtml(input: {
  ...
  return `
    <p>Admin művelet átlépte a valós idejű anomália-küszöböt.</p>
