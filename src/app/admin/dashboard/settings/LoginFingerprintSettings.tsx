    ...
    <section className="rounded-xl border border-[var(--border)] bg-background p-4 space-y-4">
      <div>
        ...
        <p className="text-sm text-muted mt-1">
          Sikeres belépéskor SHA-256 ujjlenyomatot rögzítünk (a nyers fingerprint-anyag nem megy a
          DB-be). Új eszköz vagy szokatlan ország esetén e-mail megy az <code>ADMIN_EMAIL</code>{' '}
          címre. Az első belépés a baseline, arra nincs riasztás, és a belépés soha nem blokkolódik.
        </p>
      </div>
